...
public class AddUnitsRecyclerAdapter extends RecyclerView.Adapter<AddUnitsRecyclerAdapter.RecyclerViewHolder> {
    ...
    //constructor
    public AddUnitsRecyclerAdapter(ArrayList<UnitData> unitList, String current_course_name) {
    ...
    public class RecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            final String STAFFID = LecHome.STAFFID;
            ...
            alertDialog.setButton(DialogInterface.BUTTON_POSITIVE,
                    ...
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            try {
                                response = new PushUnitToDb().execute(STAFFID,unit_code,unit_name,
                                        current_course_name).get();
                                //
                                dialog.cancel();
    ...
    public static class PushUnitToDb extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try{
                URL url =new URL(IpAddress.lec_push_unit_to_db_url);
