...
/**  */
public class FragmentMyUnits extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_my_units, container, false);
        //initialize view variables
        txt_no_units = view.findViewById(R.id.txt_no_units);
        recyclerView = view.findViewById(R.id.recycler_myunits);
    ...
    public void readMyUnitsFromDb(){
        ...
        ReadUnitsFromDb readUnitsFromDb = new ReadUnitsFromDb(getContext(),IpAddress.student_units_url);
        String unit_data="";
    ...
    public ArrayList<UnitData> processJson(String values){
        ...
        try {
            ...
            Log.d("netback","json data: "+jsonArray.length());
            int count = 0;
